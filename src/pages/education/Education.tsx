        ...
        <section className='education'>
            ...
            <li>
                ...
                <div className="timeline-start md:text-end mb-10">
                    ...
                    <div className="text-lg font-black">CEDUP Renato Ramos da Silva, Santa Catarina</div>
                    <div className="text-sm font-black mb-3">High School Diploma and Computer Technician Diploma</div>
            ...
            <li>
                ...
                <div className="timeline-end mb-10">
                    ...
                    <div className="text-lg font-black">YESBRAS, Santa Catarina</div>
                    <div className="text-sm font-black mb-3">Maintenance of Computers - Course Certificate</div>
            ...
            <li>
                ...
                <div className="timeline-start md:text-end mb-10">
                    ...
                    <div className="text-lg font-black">IMPACTA tecnologia, São Paulo</div>
                    <div className="text-sm font-black mb-3">Information Systems - Bachelor's Degree</div>
